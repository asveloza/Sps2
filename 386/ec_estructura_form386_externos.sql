/**********************************************************************/
/*  Archivo:              ec_estructura_form386_externos.sql          */
...
/**********************************************************************/
/*                        PROPOSITO                                   */
/*  Creacion de estructuras cob_externos formato 386                  */
/**********************************************************************/
/*                         MODIFICACIONES                             */
/*  FECHA         AUTOR                   RAZON                       */
...
print '********************************'
print ''
print 'Inicio Ejecucion Creacion de Tablas para Formato 386 en cob_externos : ' + convert(varchar(60),getdate(),109)
print ''

if exists (select 1 from sysobjects where name = 'ex_dato_nextday' and type = 'U') 
   drop table ex_dato_nextday
go
print '-->Tabla: ex_dato_nextday'
   create table ex_dato_nextday(
...
if exists (select 1 from sysobjects where name = 'ex_carteras_colectivas' and type = 'U') 
   drop table ex_carteras_colectivas
go
print '-->Tabla: ex_carteras_colectivas'
   create table ex_carteras_colectivas(
